const dictionary = {
  es: {
    ...
    CONCURSO_BASES_PARAGRAPH_4:
      'La categoría B2 queda reservada para el alumnado con español como lengua materna o de herencia y para todas aquellas personas que hablen español como si lo fueran por haber. Por ejemplo, para aquellos que hayan vivido más de un año en un país de habla hispana o para aquellos en cuyas familias se hable español, aunque no lo hablen a la perfección o no lo entiendan todo. Este alumnado NO puede leer en otra categoría que no sea la B2. En caso de duda, por favor, póngase en contacto con el equipo organizador del concurso en Hesse (Celia Cid Sánchez c.cid@hws.schule y Alicia Feregrino-Langer a.feregrino-langer@adolf-reichwein-schule.net). El jurado se reserva el derecho de descalificar al alumnado que no haya sido inscrito en la categoría apropiada. La elección de la categoría en la que participan los alumnos queda al criterio del profesorado que los presente al concurso. Como pauta orientativa, se establece la siguiente regla:',
    ...
    CONCURSO_BASES_PARAGRAPH_4_bis_bis:
      'El jurado tendrá en cuenta la edad de los participantes a la hora de puntuar, ya que, por el desarrollo intrínseco del alumno, la competencia lectora -tanto en la lengua materna como en la extranjera -mejora con la edad. ',
    CONCURSO_BASES_PARAGRAPH_5:
      'El alumnado que haya concursado ya en una categoría no podrá repetir en el futuro en la misma categoría, pero sí en la siguiente. Los alumnos que participen en el nivel B2 podrán volver a concursar, siempre y cuando no hayan recibido hasta el momento ningún primer premio en la final hasta el momento.',
    CONCURSO_BASES_PARAGRAPH_5bis:
      'El profesorado de alumnado que haya tenido contacto con la lengua española en la guardería o en primaria, o que tenga el español como primera lengua en secundaria, debe ponerse en contacto con la organización del concurso antes de inscribir a sus candidatos y candidatas a la semifinal en la categoría A1.',
    CONCURSO_BASES_PARAGRAPH_6:
      'Para la fecha de la semifinal, cada alumno o alumna participante habrá preparado los textos preestablecidos para su categoría de lectura, procedentes de libros de texto de español como lengua extranjera en Alemania (de A1 a B1) o textos adaptados de literatura juvenil española y latinoamericana (B2). Los textos de lectura seleccionados se podrán descargar de esta misma página web, en el apartado «Textos de lectura». Cada uno de ellos va acompañado de un audio para facilitar la práctica autónoma del alumnado en casa.',
    CONCURSO_BASES_PARAGRAPH_7:
      'Buscando la homogeneidad de los textos, en cuanto a su grado de dificultad y extensión, y para facilitar la evaluación de los/las candidatos/as por parte del jurado, ésta será la selección de textos a leer:',
    CONCURSO_BASES_PARAGRAPH_7_bis:
      'En la categoría A1 habrá tres textos, en A2 y B1 cuatro y en B2 cinco, fijados por la organización del concurso. El alumnado participante preparará todos los textos de su categoría y leerá uno de ellos, elegido al azar el día del concurso. Los textos de la categoría A1 constarán de 1300 caracteres y los de las categorías A2, B1 y B2, de 1500.',
    CONCURSO_BASES_PARAGRAPH_8:
      'Los textos para la categoría B2 son fragmentos adaptados de literatura juvenil latinoamericana.',
    ...
    CONCURSO_BASES_PARAGRAPH_10:
      'Con el fin de garantizar la ecuanimidad en la decisión del jurado, a partir de la convocatoria de 2017 se estableció que todos',
    CONCURSO_BASES_PARAGRAPH_10_bis:
      'Todos los miembros del jurado hablarán español como lengua materna o lo dominarán como si lo fuera. ',
    CONCURSO_BASES_PARAGRAPH_10_bisBis:
      'Cada miembro del jurado otorgará una puntuación a cada candidato. Una vez que hayan leído todos los candidatos de la categoría en turno y antes de proceder a la suma de puntos, los miembros del jurado deben entregar la puntuación al presidente del jurado, quien la revisará, la sumará y procederá a anunciar los resultados.',
    CONCURSO_BASES_PARAGRAPH_11:
      'En caso de que otros alumnos del colegio o los padres quieran formar parte del público en la final, el profesor o profesora acompañante deberá comunicar a las coordinadoras del concurso el número aproximado de espectadores con antelación y garantizar su «buen comportamiento».',
    CONCURSO_BASES_PARAGRAPH_12:
      'Para el alumnado ganador en la final habrá lotes de libros de las editoriales Grupo SM, Schulverlag Klett, Klett Sprachen, Cornelsen Verlag y Edinumen, licencias del juego digital para aprender español Guadalingo de la editorial Edinumen, vales de libros de la Asociación Alemana del Profesorado de Español y matrículas DELE del Instituto Cervantes de Fráncfort. Todo el alumnado participante en la final recibirá un certificado de participación. Los tres primeros puestos de cada una de las cuatro categorías de lectura contarán con certificados firmados por el Ministro de Cultura de Hesse.',
    CONCURSO_BASES_PARAGRAPH_13:
      ' Como se ha mencionado anteriormente, el proceso de selección de los candidatos y las candidatas es responsabilidad de cada centro. El nivel de lectura de los semifinalistas y finalistas debe corresponder al de la categoría en la que se han inscrito.',
    ...
    CONCURSO_BASES_PARAGRAPH_15:
      'el/la candidato/a demuestra la comprensión de lo leído a través de la segmentación correcta de las frases y el uso de recursos prosódicos. Asimismo, consigue reflejar el tono y el contexto ambiental de la lectura.',
    ...
    CONCURSO_BASES_PARAGRAPH_17:
      'En cada una de las semifinales se elegirá sólo a un alumno para ocupar el primer puesto, ya que solo una persona puede representar a la semifinal en la final del Instituto Cervantes, el segundo puesto queda como sustituto y también asiste a la final. Esta norma se hace extensiva a las cuatro categorías de lectura (A1-B2). ',
    CONCURSO_BASES_PARAGRAPH_18:
      'Todos los centros escolares que se inscriban al concurso estarán dispuestos a celebrar y organizar en su colegio una de las semifinales. En caso contrario, se deberá avisar a la organización antes de que termine el plazo de inscripción.',
    CONCURSO_BASES_PARAGRAPH_18_bis:
      'Organizar una semifinal solo requiere tener una sala grande en el colegio, contactar e invitar a los miembros del jurado con la ayuda del resto de los centros de la semifinal y recoger los premios en el Instituto Cervantes. Un representante de cada semifinal recogerá los premios para su eliminatoria en el Instituto Cervantes de Fráncfort en la fecha indicada por la organización (normalmente en febrero de cada año).',
    CONCURSO_BASES_PARAGRAPH_19:
      'Fruto de la colaboración con los consulados generales de Latinoamérica en Fráncfort, se celebrará una semifinal B2 para alumnos de países latinoamericanos. Para participar no es necesario tener la nacionalidad del país que se representa.',
    CONCURSO_BASES_PARAGRAPH_20:
      'en el Instituto Cervantes de Fráncfort, con el apoyo y bajo la tutela de los consulados latinoamericanos mencionados anteriormente. El plazo de inscripción para esta semifinal finalizará el ',
    CONCURSO_BASES_PARAGRAPH_20bis:
      'El alumnado con español como lengua materna o de herencia, procedentes de las Aulas de Lengua y Cultura Española (ALCE) organizadas por el Ministerio de Educación de España, podrán participar en la semifinal ALCE. La fecha se dará a conocer en las aulas de dicho programa de enseñanza. Participarán únicamente en la categoría B2 y podrán presentar a dos candidatos para la final que se celebrará en el Instituto Cervantes el',
    CONCURSO_BASES_PARAGRAPH_21:
      'Los alumnos con español como lengua materna o de herencia, procedentes de las Aulas de Lengua y Cultura Española (ALCE), organizadas por el Ministerio de Educación de España, podrán participar en la Semifinal ALCE. La fecha se dará a conocer en las aulas de dicho programa de enseñanza. Participarán solo en la categoría B2 y presentarán a dos candidatos para la final en el Instituto Cervantes el ',
    CONCURSO_BASES_PARAGRAPH_22:
      'donde los colegios interesados se podrán informar de los detalles del concurso. En la página se encuentran audios para practicar los textos de lectura. Asimismo, se pueden encontrar aquí diferentes impresos útiles a lo largo del concurso.',
    CONCURSO_BASES_PARAGRAPH_23:
      'Para confirmar que el colegio ha quedado correctamente inscrito, hay que consultar la lista de colegios inscritos, ya que no se envían correos de confirmación. Para la Semifinal Latinoamérica también se utilizará este medio.',
    CONCURSO_BASES_PARAGRAPH_23_bis:
      'En caso de que una semifinal se celebre en la modalidad digital, y para evitar problemas técnicos o posibles irregularidades durante la lectura, los/las candidatos/as se conectarán a las videoconferencias desde su centro escolar en compañía de su profesorado de español, quien avalará el cumplimiento de las normas establecidas.',
    ...
    FORM_WARNING:
      'LO SENTIMOS, EL PLAZO DE INSCRIPCIÓN PARA LA EDICIÓN 2025 HA FINALIZADO. PRÓXIMAMENTE SE ABRIRÁ LA INSCRIPCIÓN PARA LA EDICIÓN 2026.',
    FORM_CANCELLATION:
