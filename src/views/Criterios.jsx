    ...
    <div className="app-content pb2rem mb2rem">
      ...
      <article className="app-section-width">
        ...
        <p className="txt-left">
          ...
          pronunciación clara y correcta (en los niveles A1 y A2 no se tendrán
        ...
        <p className="txt-left">
          ...
          segmentación correcta de frases y el uso de recursos prosódicos. Así
          mismo consigue reflejar el tono y el contexto ambiental de la lectura.
        </p>
      </article>
    </div>
  );
